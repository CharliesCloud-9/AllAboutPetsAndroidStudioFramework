...
public class ExpListViewDictCat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exp_list_view_dict_cat);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);

        expList = (ExpandableListView) findViewById(R.id.exp_list);
        parentCategory = DataProvider.getInfoCat();
        ...
        expList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (parentCategory.get(childList.get(groupPosition)).get(childPosition).contains("test")) {
                    Intent intent = new Intent(ExpListViewDictCat.this, Tab1FunDapterSubActivityCat.class);
                    startActivity(intent);


                } else if(parentCategory.get(childList.get(groupPosition)).get(childPosition).contains("602 Rise")) {
                    Intent intent = new Intent(ExpListViewDictCat.this, Tab2Test.class);
                    startActivity(intent);
